    ...
    do {
      ...
      switch (num) {
        ...
        case 1:
          ...
          //make if statement for value if negative values program should be invalid
          ...
          //making a yes or no statement for carPoints
            ...
            if (answer =='n') {
              ...
              carHistory = String.format("you have been charged %.2f rm and you have earned %d points",total,carPoints);
              for( int i = history.length-1; i>=1; i--){
                history[i] = history[i-1];
              }
              history[0] = carHistory;
        ...
        case 2:
          ...
          if (foodPrice <0 || foodDistance <0) {
            ...
            carHistory = String.format("you have been charged %.2f rm and you have earned %d points",foodTotal,foodPoints);
            for( int i = history.length-1; i>=1; i--){
              history[i] = history[i-1];
            }
            history[0] = carHistory;
